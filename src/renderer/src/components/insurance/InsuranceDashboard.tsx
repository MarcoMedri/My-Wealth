        ...
        return (
            <div className="flex flex-col items-center justify-center h-full p-8 text-center text-foreground-subtle animate-in fade-in zoom-in duration-300">
                ...
                <button
                    ...
                    className="bg-emerald-500 hover:bg-emerald-600 text-white px-6 py-3 rounded-xl flex items-center gap-2 font-medium transition-all hover:shadow-lg hover:shadow-emerald-500/20 active:scale-95"
                >
    ...
    return (
        <div className="p-8 space-y-8 overflow-y-auto h-full animate-in fade-in duration-500">
            ...
            <div className="flex justify-between items-end">
                ...
                <button
                    onClick={() => setIsAddModalOpen(true)}
                    className="bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2 rounded-xl flex items-center gap-2 font-medium transition-all hover:shadow-lg hover:shadow-emerald-500/20 active:scale-95"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-background-card p-6 rounded-2xl shadow-sm border border-border/50 backdrop-blur-sm">
                    <div className="text-sm font-medium text-foreground-muted mb-2 flex items-center gap-2">
                        ...
                        {t('insurance.totalValue')} (Annualized)
                    </div>
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4">
                    {insurance.map(policy => (
                        <div
                            key={policy.id}
                            className="group bg-background-card p-5 rounded-2xl border border-border/50 hover:border-emerald-500/30 hover:shadow-md transition-all duration-200"
                        >
